...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script( 'jquerymin', get_template_directory_uri().'/js/jquery.min.js', array(), '2.1.3' ,true); /* TRUE Es para agregarlo al footer */
        wp_enqueue_script('jquerymin');

        wp_register_script('scripts', get_template_directory_uri() .'/js/scripts.js', array('jquerymin'),'1.0.0');
        ...
        wp_register_script("owl-carousel", get_template_directory_uri() .'/js/owl.carousel.min.js',array('jquerymin'),'1.0.0');
        wp_enqueue_script('owl-carousel');

        wp_register_script('stratum', get_template_directory_uri().'/js/stratum.min.js', array('jquerymin'), '1.0.0');
        wp_enqueue_script('stratum');

        wp_register_script("assets", get_template_directory_uri() .'/js/assets.js',array('jquerymin'),'1.1.0',true);
        wp_enqueue_script('assets');

        // if(is_category()){
        //      wp_register_script('scripts','categoryId',"abc");
        //     $categories = get_the_category();
        //     if(! empty( $categories )){
        //         wp_register_script('scripts','categoryId',$categories[0]->$term_id);    
        //     }
...
function html5blank_styles()
{
    ...
    wp_register_style('lookliverpool', get_template_directory_uri() .'/styles/liverpool_look.css',array(),'1.1.1','all');
    ...
    wp_style_add_data("fontawesome","crossorigin","anonymous");
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        'header-menu' => __('Header Menu', 'lookliverpool'), // Main Navigation
        'sidebar-menu' => __('Sidebar Menu', 'lookliverpool'), // Sidebar Navigation
        'extra-menu' => __('Extra Menu', 'lookliverpool') // Extra Navigation if needed (duplicate as many as you need!)
    ));
}
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        'name' => __('Widget Area 1', 'lookliverpool'),
        'description' => __('Description for this widget-area...', 'lookliverpool'),
        'id' => 'widget-area-1',
    ...
    register_sidebar(array(
        'name' => __('Widget Area 2', 'lookliverpool'),
        'description' => __('Description for this widget-area...', 'lookliverpool'),
        'id' => 'widget-area-2',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
...
{
    global $post;
    return '... <a class="view-article" href="' . get_permalink($post->ID) . '">' . __('View Article', 'lookliverpool') . '</a>';
}
